...
public class Marker extends Rectangle {
    ...
    /**
     * Changes the colour used for drawing. When a ship is assigned will use
     * HIT_COLOUR,
    ...
    /**
     * If not previously marked it will tell that associated ship that another section has not been destroyed. Then remove the marker
     */
    public void unMark() {
        if (isShip()) {
            shipAtMarker.undoDestroySection();
        }
        showMarker = false;
    }
